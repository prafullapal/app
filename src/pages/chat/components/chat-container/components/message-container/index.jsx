...
const MessageContainer = () => {
  ...
  const checkIfImage = (filePath) => {
    const imageRegex =
      /\.(jpeg|jpg|gif|png|bmp|svg|webp|tiff|tif|ico|heic|heif)$/i;
        ...
        {message.sender._id !== userInfo._id ? (
          <div className="flex items-center justify-start gap-3">
            <Avatar className="h-8 w-8 rounded-full overflow-hidden">
              ...
              <AvatarFallback
                className={`h-8 w-8 text-lg border-[1px] bg-[#1b1c24] text-white/90 flex items-center  justify-center  rounded-full ${getColor(
              ...
              >
                {message.sender.firstName
                  ? message.sender.firstName
                      ...
                      .shift()
                      .toLocaleUpperCase()
                  : message.sender.email.split("").shift().toLocaleUpperCase()}
              </AvatarFallback>
            </Avatar>
